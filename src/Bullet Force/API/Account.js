export class Account {
    ...
    async generateAccount() {
        ...
        const response = await fetch(
            'https://server.blayzegames.com/OnlineAccountSystem/register.php?&requiredForMobile=192447214', {
                method: 'POST',
                headers: {
                    accept: '*/*',
        ...
        if (responseData.includes('success')) {
            return {
                ...
                password: this.passwordNonHashed,
            };
        } else {
            return {
                message: 'fail',
