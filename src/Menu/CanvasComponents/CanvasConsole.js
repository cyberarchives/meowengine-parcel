...
export class CanvasConsole {
  static createConsole() {
    ...
    logContainer.style.boxShadow =
      "0 4px 20px rgba(0, 255, 170, 0.3), 0 0 15px rgba(0, 255, 170, 0.2)";
    ...
    title.innerHTML =
      '✧ MeowLog <span style="font-size:11px;opacity:0.7;">v2.0</span>';
    ...
    content.style.scrollbarColor =
      "rgba(0, 255, 170, 0.5) rgba(15, 23, 42, 0.3)";
    ...
    setTimeout(() => {
        ...
        "<color=#00ffaa>✓</color> MeowLog console <bold>initialized</bold> <glow>successfully</glow>"
      );
    }, 100);
